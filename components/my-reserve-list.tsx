          ...
          <div className="flex items-end justify-end absolute inset-4">
            {item.Payment?.status === "unpaid" ? (
              <Link
                ...
                className="px-6 py-1 bg-orange-400 text-white rounded-sm hover:bg-orange-500"
              >
                Pay Now
              </Link>
            ) : (
              <Link
                ...
                className="px-5 py-1 bg-orange-400 text-white rounded-sm hover:bg-orange-500"
              >
                View Detail
              </Link>
            )}
